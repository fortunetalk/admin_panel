...
const DisplayPoojaCategory = ({ poojaCategoryData }) => {
  const dispatch = useDispatch();

  useEffect(() => {
    if (!poojaCategoryData || poojaCategoryData.length === 0) {
  ...
  const [poojaCategory_id, setpoojaCategory_id] = useState("");
  ...
  const validation = () => {
    let isValid = true;
    if (!poojaCategory) {
      handleError("poojaCategory", "Please enter product category");
      isValid = false;
    }
    if (!status) {
  ...
  return (
    <div className={classes.container}>
      {
        !poojaCategoryData ? <CircularProgress/> :
        ...
        <Grid item lg={12} sm={12} md={12} xs={12}>
          <MaterialTable
            ...
            columns={[
              {
                ...
                editable: "never",
                render: (rowData) =>
                  Array.isArray(poojaCategoryData)
                    ? poojaCategoryData?.indexOf(rowData) + 1
                    : "N/A",
              },
            ...
            actions={[
              ...
              {
                icon: "edit",
                tooltip: "Edit Pooja Category",
                onClick: (event, rowData) => handleOpen(rowData),
              },
              {
                icon: "delete",
                tooltip: "Delete Pooja Category",
              ...
              },
              {
                ...
                tooltip: "Add Pooja Category",
                isFreeAction: true,
                onClick: () =>
                  navigate("/fortune-store/create-pooja-category"),
              },
            ]}
          />
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item lg={12} sm={12} md={12} xs={12}>
            <div className={classes.headingContainer}>
              <div className={classes.heading}>Edit Pooja Category</div>
