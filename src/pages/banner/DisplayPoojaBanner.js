...
const DisplayPoojaBanner = ({ dispatch, poojaBannerData }) => {
  ...
  useEffect(function () {
    dispatch(Actions.getPoojaBannerData());
  }, []);
  ...
  const handleSubmit = async () => {
    if (validation()) {
      ...
      dispatch(
        Actions.updatePoojaBanner(formData)
      );
    setOpen(false);
  ...
  const handleClickOpen = (rowData) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        dispatch(Actions.updatePoojaBannerStatus({ bannerId: rowData._id, status: newStatus }));
      }
    });
  };
      ...
      <Grid container spacing={1}>
        <Grid item lg={12} sm={12} md={12} xs={12}>
          <MaterialTable
            ...
            data={poojaBannerData}
            columns={[
              {
                title: "S.No",
                editable: "never",
                render: rowData => Array.isArray(poojaBannerData) ? poojaBannerData.indexOf(rowData) + 1 : 'N/A'
              },
          ...
          <Grid item lg={6} sm={12} md={6} xs={12}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="poojaCategory">Pooja Category</MenuItem>
                </Select>
...
export default connect(mapStateToProps, mapDispatchToProps)(DisplayPoojaBanner);
