...
export const get_live_class_history = 'admin/booked_live_class'
export const change_live_class_history_status = 'admin/booked_live_class/change_status'
export const delete_live_class_history = 'admin/booked_live_class/delete'
