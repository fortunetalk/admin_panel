...
const AddCallChatBanner = ({ dispatch }) => {
  ...
  const handleSubmit = async () => {
    if (validation()) {
      ...
      dispatch(Actions.createCallChatBanner(formData));
      handleReset();
    }
  };
        ...
        <Grid container spacing={2}>
          <Grid item lg={12} sm={12} md={12} xs={12}>
            <div className={classes.headingContainer}>
              <div className={classes.heading}>Add Call/Chat Banner</div>
              <div
                onClick={() => navigate("/display-Call-Chat-Banner")}
                className={classes.addButton}
              >
                <DvrIcon />
                <div className={classes.addButtontext}>Display Call/Chat Banner</div>
              </div>
            </div>
          </Grid>
