...
const AppReviews = ({ dispatch, isLoading, astrologersReviews }) => {
  ...
  const handleDelete = async (rowData) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        var response = await postData(delete_review, { reviewId: rowData._id });
        if (response.success) {
          Swal.fire({
            title: "Deleted!",
              ...
              { title: "ratings", field: "ratings" },
              {
                ...
                render: (rowData) => {
                  return (
                    ...
                    >
                      {!rowData.is_verified ? "Unverify" : "Verify"}
                    </div>
                  );
                },
              },
...
export default connect(mapStateToProps, mapDispatchToProps)(AppReviews)