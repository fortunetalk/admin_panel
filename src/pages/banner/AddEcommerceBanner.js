...
const AddEcommerceBanner = ({ dispatch }) => {
  ...
  const handleSubmit = async () => {
    if (validation()) {
      ...
      dispatch(Actions.createEcommerceBanner(formData));
      handleReset();
    }
  };
        ...
        <Grid container spacing={2}>
          <Grid item lg={12} sm={12} md={12} xs={12}>
            <div className={classes.headingContainer}>
              <div className={classes.heading}>Add Ecommerce Banner</div>
              <div
                onClick={() => navigate("/displayEcommerceBanner")}
                className={classes.addButton}
              >
                <DvrIcon />
                <div className={classes.addButtontext}>Display Ecommerce Banner</div>
              </div>
            </div>
          </Grid>
...
export default connect(null, mapDispatchToProps)(AddEcommerceBanner);
