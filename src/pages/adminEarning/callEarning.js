...
export const CallEarning = ({dispatch, adminEarningData}) => {
  ...
  useEffect(()=>{
    dispatch(ReportsActions.getCallEarnings())
  }, [])
        ...
        columns={[
            ...
            { title: 'Admin Share', render: rowData => `${rowData.commissionPrice}` },
            {
                ...
                render: rowData => {
                  ...
                  const astrologerShare = parseFloat(rowData.callPrice) - parseFloat(rowData.commissionPrice);
                  return astrologerShare.toFixed(2); 
                }
              },
            { title: 'Total Charge', render: rowData =>`${rowData.deductedAmount}` },
            { title: 'Amount', render: rowData => parseFloat(rowData.callPrice).toFixed(2) },
...
export default connect(mapStateToProps, mapDispatchToProps)(CallEarning);